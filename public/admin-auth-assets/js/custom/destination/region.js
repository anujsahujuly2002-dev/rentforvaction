...
$(function () {
    table = $("#region").DataTable({
        ...
        bLengthChange: false,
        ajax: {
            url: site_url + "/admin/destination/region",
        },
        dataType: "html",
        columns: [
            {
    ...
    $("#region").on("error.dt", function (e, settings, techNote, message) {
...
$("#region-create").on("submit", function (e) {
    e.preventDefault();
    showLoader();
    $.ajax({
        url: site_url + "/admin/destination/region/store",
        type: "POST",
...
$("#region-edit").on("submit", function (e) {
    e.preventDefault();
    showLoader();
    $.ajax({
        url: site_url + "/admin/destination/region/update",
        type: "POST",
        data: new FormData(this),
        contentType: false,
        cache: false,
...
function deleteRegion(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            showLoader();
            $.ajax({
                url: site_url + "/admin/destination/region/delete",
                type: "POST",
                dataType: "json",
                data: { id: id },
                cache: false,
