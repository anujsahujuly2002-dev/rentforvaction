...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-md-6">
            <h4 class="fw-bold py-3 mb-4">Sub City Create</h4>

        </div>
        <div class="col-md-6">
            <a href="{{ route('admin.destination.subcity.index') }}" class="btn btn-primary text-right" style="float: right">Back</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <form id="sub-city-create">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            @csrf
