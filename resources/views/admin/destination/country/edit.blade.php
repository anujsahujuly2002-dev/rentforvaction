...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-md-6">
            <h4 class="fw-bold py-3 mb-4">Country Edit</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"  class="form-control" id="country_name" placeholder="Country Name" name="country_name" value="{{ $country->name }}">
