...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-6">
                <h4 class="fw-bold py-3 mb-4">Role Create</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="role-name" placeholder="Role Name" name="role_name">
                                        ...
                                        @if (!empty($permission))
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-check form-check-inline mt-3">
                                                    <input class="form-check-input" type="checkbox" name="permission_id[]" value="{{ $per->id }}"  id="per{{ $per->id }}"/>
